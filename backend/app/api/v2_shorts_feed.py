...
CANDIDATES: list[dict] = [
    ...
    },
    {
        ...
        "sector": "조선 · 미 해군 MRO",
        "narrative": "필라델피아 조선소 인수 + 미 해군 MRO 진출로 미국 조선업 재건 정책 수혜 → 상선 고선가 물량과 별개로 방산 수주 확대",
        "thesis_type": "정책수혜+사이클전환",
        "facts": [
            {"label": "매출", "value": "4조8,602억 → 10조7,760억 (2.2배)", "period": "2022→2024"},
            {"label": "영업이익", "value": "-1조6,136억(적자) → 2,379억(흑자전환)", "period": "2022→2024"},
            {"label": "영업이익률", "value": "2.2%", "period": "2024"},
        ],
        "dart_verified": True,
        "target_scenario": "미 해군 MRO·방산 수주 확대 + 후판가 안정화로 흑자 폭 확대",
        "risk_note": "부채비율 267%(부채 12조9,805억·자본 4조8,633억)로 여전히 높고, 영업이익률 2.2%는 흑자전환 초기 단계라 이익 절대 규모가 작다. HD한국조선해양과 같은 조선업 턴어라운드 서사라 소재가 겹친다 — 두 종목을 같은 회차에 함께 다루지 않는다.",
        "broll_keywords": ["필라델피아 조선소", "미 해군 함정", "방산 건조"],
    },
    {
        "ticker": "103140", "name": "풍산",
        "sector": "방산 · 신동(가공동)",
        "narrative": "구리 가격 강세 + K-방산 탄약 수출 확대 → 신동사업 마진 개선과 방산 수주 잔고가 동시에 실적 견인",
        "thesis_type": "원자재사이클+방산수출",
        "facts": [
            {"label": "매출", "value": "4조3,730억 → 4조1,253억 → 4조5,544억", "period": "2022→2023→2024"},
            {"label": "영업이익", "value": "2,316억 → 2,286억 → 3,238억", "period": "2022→2023→2024"},
            {"label": "영업이익률", "value": "5.3% → 5.5% → 7.1%", "period": "2022→2023→2024"},
        ],
        "dart_verified": True,
        "target_scenario": "구리 가격 강세 지속 + 탄약 수출 확대로 신동·방산 두 사업부 동반 실적 개선",
        "risk_note": "★2024 매출(4조5,544억)이 2022년(4조3,730억)보다 소폭 높은 수준에 그친다. 구리 가격에 연동된 원자재 사이클 업종이라 '이미 증명된 성장'보다는 가격 사이클 반등으로 다뤄야 하고, 영업이익률도 7%대로 낮다.",
        "broll_keywords": ["탄약 생산라인", "구리 압연", "방산 수출"],
    },
]
